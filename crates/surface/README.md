...
mémoire résidente. `--repos N` mesure la consommation au repos : il rejoue pendant N secondes
la politique de redessin de la fenêtre et imprime les images rendues et le temps processeur. Sur un rastériseur logiciel elle mesure le processeur ; sur une carte
