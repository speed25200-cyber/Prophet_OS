...
file_tool!(
    Search,
    "fs.search",
    "Cherche par nom ou contenu dans les descendants autorisés. Sans liens ; 200 résultats, 256 Kio par fichier, 8 Mio de contenu au total. Une recherche incomplète est signalée.",
    "fs.read",
    Search,
    "root",
    json!({
